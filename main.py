    ...
    try:
        ...
        if item_w == 0:
            ...
            if package + item_w <= 20:
                ...
                print("Package {}, its in the maximun load with {}kg. \nCannot add this item with {}kg to this package, sending this Item to the next Package.\n\n".format(n_package, package, item_w))
...
if package < 20 and package < non_optimal_package:
    ...
    amount_unused_package = 20 - package
    non_optimal_package = package
    print("Package Number: {} had the most 'unused' capacity, with an amount of {}kg unused.".format(min_unused_n_package, amount_unused_package))
else:
    print("Package Number: {} had the most 'unused' capacity, with an amount of {}kg unused.".format(min_unused_n_package, amount_unused_package))
